...
path = "/home/rrupadhyay/signature/gen_forge/test"  ## data/gen_forge
...
print(resized_images[0].shape)  ## (height, width)
...
features.to_csv("/home/rrupadhyay/signature/prep_data/gen_forg_test.csv", index = False) ## gen_forg data
