...
path = "/home/rrupadhyay/signature/only_genuine/test/genuine"  ## data/only_genuine
...
features.to_csv("/home/rrupadhyay/signature/prep_data/genuine_test.csv", index = False)
